...
output_dimensions = 1
# Domain Extrema
extrema_values = torch.tensor([[-2.5, 2.5],  # Time t; single peri [0., 50.]; double line [-2.5, 2.5]; double peri
...
def compute_res(network, x_f_train, space_dimensions, solid_object, computing_error=False):
    ...
    #double, extended y, extend data for computing Hilbert trans

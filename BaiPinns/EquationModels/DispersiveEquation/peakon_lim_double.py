...
alpha1_ = -2 # -2. for lim1; -0.2 for lim2 lim3
...
alpha2_ = 2 # 2. for lim1; 0.2 for lim2 lim3
...
def y_x(x, t=0, alpha=0):
    return optimize.bisect(lambda y: x_y(y, t) - x, -100., 100.) # -100., 100. for lim1; -10., 10. for lim2 lim3
